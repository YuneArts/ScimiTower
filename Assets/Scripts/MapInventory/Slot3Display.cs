...
public class Slot3Display : MonoBehaviour
{
    public WeaponData slot3Weapon;
    ...
    void Start()
    {
        slot3Weapon = DataHolder.Instance.playerInventory.Container[2];

        SetWeaponElement(slot3Weapon.element);
        SetWeaponAlignment(slot3Weapon.alignment);
    }

    private void SetWeaponElement(WeaponElement eleCheck)
    {
        switch (slot3Weapon.element)
        {
